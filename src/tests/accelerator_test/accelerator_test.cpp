...
int main(){
	...
	A.addDipole(Vector3D(0,0,0), Vector3D(1,0,0), 0.5, 0.5, 2.0);
	A.addQuadrupole(Vector3D(1,0,0), Vector3D(2,0,0), 1.0, 2.0, 1.0);
	A.addStraightSection(Vector3D(2,0,0), Vector3D(3,0,0), 1.0);
