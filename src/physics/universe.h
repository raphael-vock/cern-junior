...
class Universe{
	...
	public:
		...
		void insert(Vector3D x_0 = basicvector::ZERO_VECTOR, Vector3D v_0 = basicvector::ZERO_VECTOR, double my_mass = Particle::DEFAULT_MASS, double my_charge = 0.0, double my_radius = Particle::DEFAULT_RADIUS);
