...
namespace excptn{
	...
	const std::invalid_argument INFINITE_CURVATURE_CENTER("Center of circle with infinite curvature is undefined");
	const std::invalid_argument INFINITE_CURVATURE_DIPOLE("Dipole must have finite curvature");
