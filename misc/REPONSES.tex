...
\node (L0) at (0,0) {};
\node (R0) at (3,0) {};
\node (T0) at (3,0) [label=right: hérite de] {};

\node (L1) at (0,-1) {};
\node (R1) at (3,-1) {};
\node (T1) at (3,-1) [label=right: hérite de \textit{via} \T{template}] {};

\node (L2) at (0,-2) {};
\node (R2) at (3,-2) {};
\node (T2) at (3,-2) [label=right: contient une ou plusieurs instances de] {};

\node (L3) at (0,-3) {};
\node (R3) at (3,-3) {};
\node (T3) at (3,-3) [label=right: contient un ou plusieurs pointeurs vers des instances de] {};
