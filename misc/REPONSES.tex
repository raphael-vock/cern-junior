...
\ \linebreak
\textbf{(P6.2)} \begin{comment} Comment représenter les champs électiques/magnétiques \T{B} et \T{E} ?
...
\newpage
\section{Quelques schémas}

Les schémas ci dessous représentent l'organisation des différentes classes du projet, dans sa conception graphique et physique. 
...
\node (P3) at (12, -2) {\T{opengl\_view}};
\node (P4) at (15, -2) {\T{textview}};
\node (P5) at (6,-2) {\T{Accelerator}};
\node (P6) at (3,-2) {\T{Particle}};
\node (P7) at (0,-2) {\T{Box}};
\node (P8) at (10.5,-6) {\T{text\_widget}};
\node (P9) at (9.25,-3.5) {\T{GLWidget}};
...
\node (P2) at (2,-8) [rectangle,draw] {\T{vector<unique\_ptr<unique\_ptr>\,>\,>}}; 
\node (P9) at (2, -6) {\T{Particle}};
\node (P3) at (12, -10) {\T{Beam}};
\node (P4) at (12, 0) {\T{Accelerator}};
\node (P5) at (12, -2) [rectangle,draw] {\T{vector<>}};
\node (P6) at (12, -4) {\T{Element}};
\node (P7) at (12, -6) {\T{Node}};
\node (P8) at (8.66, -8) {\T{Box}};

\draw
(P4) edge [--] (P5)
(P3) edge [-- , bend left = 20] (P2.south)

(P7) edge [-> , loop right, dashed, red] (P7)
(P4) edge [-> , red] (P0)
(P1) edge [->] (P0)
(P9) edge [->] (P1)
(P2) edge [->] (P9)
...
(P4.south east) edge [-> , bend left = 60, dashed, red] (P3.north east)
(P3.south east) edge [-> , bend left = -60, dashed, red] (P4.north east)
\end{tikzpicture}
...
\node (L0) at (0,0) {};
\node (R0) at (3,0) {};
\node (T0) at (4,0) {: `hérite de'}; 
\node (L1) at (0,-1) {}; 
\node (R1) at (3,-1) {}; 
\node (T1) at (6,-1) {: `contient un/des instance(s) de'}; 
\node (L2) at (0,-2) {}; 
\node (R2) at (3, -2) {}; 
\node (T2) at (7.5,-2) {: `contient un/des pointeurs vers une instance de'}; 

\draw
(L0) edge [->] (R0)
(L1) edge [->  red] (R1)
(L2) edge [-> , red, dashed] (R2)
